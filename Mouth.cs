...
public class Mouth : MonoBehaviour
{
    ...
    public void PartCreator()
    {
        ...
        for (int i = 0; i < _mouthes.Count; i++)
        {
            _holder = Instantiate(_itemTemplate, _scroolView);
            _holder.transform.GetChild(0).GetComponent<Image>().sprite = _mouthes[i];
    ...
    {
        Profile.Instance._avatarMouth.GetComponent<Image>().sprite = _mouthes[_itemIndex];
